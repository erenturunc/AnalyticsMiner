mobileLandingPageAnalysis <- function(ClientID, ClientSecret, ViewID, StartDate, EndDate, SplitDaywise = T){
  ...
  ###Mobile Landing Pages Analysis - START###  
  ...
  ###Mobile Landing Pages Analysis - END###
